...
- [ ] **Step 1: Write the failing unit tests for utilities**
- [ ] **Step 2: Run `npm test frontend/__tests__/neobank/utils.test.ts` to verify tests fail**
- [ ] **Step 3: Implement `frontend/lib/neobank/types.ts` and `frontend/lib/neobank/utils.ts`**
- [ ] **Step 4: Run `npm test frontend/__tests__/neobank/utils.test.ts` and verify 100% pass**
...
- [ ] **Step 1: Write unit tests for `StoriesBar` and `StoryViewerModal`**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `StoriesBar.tsx` and `StoryViewerModal.tsx` with Framer Motion transitions**
...
- [ ] **Step 1: Write unit tests for `HeroProductCarousel`**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `HeroProductCarousel`, `VaultCard`, and `DigitalCardPreview`**
...
- [ ] **Step 1: Write unit tests for `QuickActionHub` and `FastPayCarousel`**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `QuickActionHub.tsx` and `FastPayCarousel.tsx`**
- [ ] **Step 4: Run test and verify pass**
- [ ] **Step 5: Commit changes**
...
- [ ] **Step 1: Write unit tests for `SmartTransferHub` (auto-routing resolution, fee calculation, submission)**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `SmartTransferHub.tsx` and integrate into `/client/send/page.tsx`**
- [ ] **Step 4: Run test and verify pass**
- [ ] **Step 5: Commit changes**
...
- [ ] **Step 1: Write unit tests for `DailyActivityFeed` and `ReceiptModal`**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `DailyActivityFeed.tsx` and `ReceiptModal.tsx`**
- [ ] **Step 4: Run test and verify pass**
- [ ] **Step 5: Commit changes**
...
- [ ] **Step 1: Write unit tests for `AnalyticsStudio`**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `AnalyticsStudio.tsx` and `frontend/app/client/analytics/page.tsx`**
- [ ] **Step 4: Run test and verify pass**
- [ ] **Step 5: Commit changes**
...
- [ ] **Step 1: Write unit tests for `CardSecurityHub`**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `CardSecurityHub.tsx` and update `/client/cards/page.tsx`**
- [ ] **Step 4: Run test and verify pass**
- [ ] **Step 5: Commit changes**
...
- [ ] **Step 1: Write unit tests for `SimLabDrawer` (verifying role restriction: hidden for `user`, visible for `admin`)**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Implement `SimLabDrawer.tsx` with role guard**
- [ ] **Step 4: Run test and verify pass**
- [ ] **Step 5: Commit changes**
...
- [ ] **Step 1: Write integration tests for `ClientDashboard`**
- [ ] **Step 2: Run test to verify failure**
- [ ] **Step 3: Update `page.tsx`, `Sidebar.tsx`, and `layout.tsx`**
- [ ] **Step 4: Run test and verify pass**
- [ ] **Step 5: Commit changes**
...
- [ ] **Step 1: Run `npm test -- --coverage` across all frontend components**
- [ ] **Step 2: Run `npx tsc --noEmit` in `frontend/` to confirm 0 type errors**
- [ ] **Step 3: Run root `pytest` to confirm 114/114 backend & simulator tests remain green**
