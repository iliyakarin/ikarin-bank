...
export default function DashboardPage() {
  ...
  const {
    ...
    refetching,
  } = useTransactions(dayFilter * 24, true);
  const {
    balance,
    reservedBalance,
    accounts,
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        >
          ...
          <p className="text-white/40 font-medium">
            Your financial health is at its peak this month.
          </p>
        </motion.div>
      ...
      >
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 space-y-4 hover:scale-105 transition-transform duration-300">
          ...
          <div>
            ...
            <p
              className={`text-2xl lg:text-3xl font-bold ${stats.totalIncome >= stats.totalExpenses ? "text-emerald-400" : "text-rose-400"}`}
            >
