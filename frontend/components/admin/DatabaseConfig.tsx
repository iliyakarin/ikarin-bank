...
import { Database, MessageSquare, Settings, Eye, EyeOff, Shield, Key } from 'lucide-react';
...
export default function DatabaseConfig({ config, onChange, onTestConnection, connectionStatus }: DatabaseConfigProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="p-6 bg-black/20 rounded-2xl border border-white/10 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input
            ...
            className="px-4 py-3 bg-black/20 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-white/20"
          />
          <input
            type="text"
            placeholder="Port"
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 bg-black/20 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-white/20"
            />
            <button
          ...
          <input
            ...
            className="md:col-span-2 px-4 py-3 bg-black/20 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-white/20"
          />
        </div>
      </div>
      ...
      <div className="p-6 bg-black/20 rounded-2xl border border-white/10 space-y-4">
        ...
        <div className="space-y-4">
          <input
            ...
            className="w-full px-4 py-3 bg-black/20 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:border-white/20"
          />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              type="text"
      ...
      <div className="flex items-center gap-3 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-xl">
        ...
        <div className="text-sm text-yellow-200">
          ...
          <p className="text-yellow-300">These credentials are only stored in browser memory and used for read-only operations.</p>
        </div>
      </div>
    </div>
  );
