...
GRANT INSERT ON banking.transactions TO ${AUDIT_LOGGER_USER};
GRANT INSERT ON banking.activity_events TO ${AUDIT_LOGGER_USER};
...
GRANT SELECT ON banking.transactions_view TO ${AUDIT_LOGGER_USER};
